...
"""
我的标识符没有较高的____，但它有很高的____。这意味着，几乎每次当我的测试集中出现 POI 时，我都能找出他或她。
但这么做的代价是有时我会得到 false positives，这时非 POI 会被错误地标记为 POI。
...
"""
我的标识符没有较高的____，但它有很高的____。这意味着每当我的测试集中 POI 被标记时，
我将很确定它是真的 POI， 而非假警报。另一方面，这样做的代价是有时我会错过真 POI，
因为我实际上避免了在边缘情况下触发标记。
...
"""
我的识别符有非常好的____。这是两个世界中最好的识别符，我的 false positive 和 false negative 率均为____，这意味着我可以可靠、准确地识别 POI。如果我的识别符发现了 POI，那么此人几乎可以肯定是 POI，而且如果识别符没有标记某人，那么几乎可以肯定他们不是 POI。
